...
public class HttpUtils {
	 ...
	 */
	public static String doPost(String addressHost,
			Map<String, String> parameters, String protocal, String jsonOrxml) throws IOException {
	 ...
	 * @throwsIOException
	 */
	private static String makeContent(String urlString,
	...
	public static void main(String[] args) {
		String str = HttpUtils.doGet("http://localhost:8080/file_upload/login/checkSid.do", "sid=2BCC5DB9F57EBA2A349D7D696617A36E");
